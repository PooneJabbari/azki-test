...
const inputStyles = cva("block w-full text-right", {
  variants: {
    ...
    variant: {
      default:
        "rounded-md border border-gray-300 px-3 py-2 placeholder-gray-300 focus:border-primary-500 focus:outline-none focus:ring-primary-500 text-xs sm:text-sm disabled:ring-gray-300 disabled:text-gray-500",
      search:
